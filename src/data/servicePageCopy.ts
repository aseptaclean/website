 ...
 *   docs/aseptaclean-all-website-copy.md            Hoarding · Severe Property Cleanup · Detailed Deep Cleaning
 *   docs/aseptaclean-crime-scene-trauma-cleanup.md  Crime Scene & Trauma Cleanup
 *
 * Rodent Droppings & Animal Waste Cleanup was REMOVED from this file 2026-09-16 — that route no
 * longer renders through AcServicePage. Its copy now lives in src/data/rodentServicePage.ts,
 * sourced from the owner-approved docs/Aseptaclean_Rodent_Service_Page_Copy.md. See

...
| Campaign (paid-traffic) landing pages | page-briefs/PPC-HOARDING-SAN-JOSE.md, with the route inventory in SITEMAP-MASTER.md § "Campaign routes" | Each campaign brief governs its own route only. It carries its own copy — never the SEO page's — and its scoped PPC exceptions (compact header/footer, no navigation, indexation per SITEMAP-MASTER.md; the two assessment pages became indexable by owner decision 2026-09-15) are deliberate. It cannot change any other route's copy, indexation or navigation. |

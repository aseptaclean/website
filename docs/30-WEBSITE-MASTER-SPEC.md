...
quiet differentiation / scope control

OPERATING EVIDENCE / HOW ASEPTACLEAN WORKS
large field image + restrained artifact/accountability
...
This replaces duplicate recognition + giant service sections.

Three strong photographic routes can represent:

- overwhelming contents / hoarding;
- neglected / heavily soiled property;
- estate / move-out / transition.

Use real active routes.
...
Explain only the useful distinction:

- maintained routine cleaning;
- condition-specific project;
- defined scope;
- handoff.

Do not create a giant process register.

## Operating evidence

Concentrate trust into one substantial movement.

Possible ingredients:

- real/temporary operational image;
- sample handoff artifact;
- direct accountability;
- deeper link to `/handoff-standard/` or `/about/`.

No empty founder-photo box.
...
- Fit/Boundaries;
- giant FAQ;
- separate founder essay;
- separate service directory;
- separate Clear Scope section;
- project placeholder;
- homepage lead form.
